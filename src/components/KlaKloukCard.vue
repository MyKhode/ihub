<template>
  <div  @click="$emit('place-bet', title, handleClick)"
    class="relative w-28 h-28 md:w-56 md:h-56 lg:w-80 lg:h-80 cursor-pointer rounded-lg border-4 lg:border-8 border-yellow-500 flex items-center justify-center hover:bg-zinc-600 dark:hover:bg-zinc-800"
