...
<template>
  <div id="toast-success"
    class="fixed flex lg:right-10 lg:top-20 right-2 top-2 z-30 dark:text-gray-400 dark:bg-gray-800 mb-4 flex w-full max-w-xs items-center rounded-lg bg-white p-4 text-gray-500 shadow"
    role="alert">
